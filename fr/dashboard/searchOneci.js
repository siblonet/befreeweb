...
const SelectedCooperative = async (encodedId) => {
    ...
    document.getElementById('respond').innerHTML = `
                    <div class="odeaaa" id="">   
                        <a  style="height: 50%; width: 50%;" class="" id="" href="fr/dashboard/asserts/ESTATIO.pdf"  target="_blank">
                            <img src="fr/dashboard/asserts/cafecaca.png"
                            style="height: 50%; width: 50%;" alt="">
                        </a>

                        <a style="height: 50%; width: 30%;" class="" id="" href="fr/dashboard/asserts/ascapdd.JPEG"  target="_blank">
